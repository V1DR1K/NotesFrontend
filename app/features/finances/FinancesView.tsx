...
export function FinancesView({ config }: { config: ApiConfig }) {
  ...
  const data = useFinanceData(page, bucket, date, itemCode);
  ...
  const resetFilters = () => { setDate(""); setItemCode("all"); setPage(0); };
